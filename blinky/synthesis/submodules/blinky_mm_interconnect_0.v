...
module blinky_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_ram_s1_agent:cp_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> switches_s1_agent:cp_data
	...
	wire  [94:0] red_leds_s1_agent_rf_source_data;                                          // red_leds_s1_agent:rf_source_data -> red_leds_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] red_leds_s1_agent_rsp_fifo_out_data;                                       // red_leds_s1_agent_rsp_fifo:out_data -> red_leds_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> red_leds_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // red_leds_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> red_leds_s1_agent:cp_channel
	...
	wire  [94:0] sev_seg_0_s1_agent_rf_source_data;                                         // sev_seg_0_s1_agent:rf_source_data -> sev_seg_0_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] sev_seg_0_s1_agent_rsp_fifo_out_data;                                      // sev_seg_0_s1_agent_rsp_fifo:out_data -> sev_seg_0_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> sev_seg_0_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // sev_seg_0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> sev_seg_0_s1_agent:cp_channel
	...
	wire  [94:0] randoms_s1_agent_rf_source_data;                                           // randoms_s1_agent:rf_source_data -> randoms_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] randoms_s1_agent_rsp_fifo_out_data;                                        // randoms_s1_agent_rsp_fifo:out_data -> randoms_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> randoms_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // randoms_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> randoms_s1_agent:cp_channel
	...
	wire  [94:0] grn_leds_s1_agent_rf_source_data;                                          // grn_leds_s1_agent:rf_source_data -> grn_leds_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] grn_leds_s1_agent_rsp_fifo_out_data;                                       // grn_leds_s1_agent_rsp_fifo:out_data -> grn_leds_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> grn_leds_s1_agent:cp_valid
	wire  [93:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> grn_leds_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // grn_leds_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> grn_leds_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> grn_leds_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> grn_leds_s1_agent:cp_endofpacket
	...
	wire  [93:0] onchip_ram_s1_agent_rp_data;                                               // onchip_ram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [93:0] switches_s1_agent_rp_data;                                                 // switches_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] red_leds_s1_agent_rp_data;                                                 // red_leds_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [93:0] sev_seg_0_s1_agent_rp_data;                                                // sev_seg_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [93:0] randoms_s1_agent_rp_data;                                                  // randoms_s1_agent:rp_data -> router_008:sink_data
	...
	wire         grn_leds_s1_agent_rp_valid;                                                // grn_leds_s1_agent:rp_valid -> router_009:sink_valid
	wire  [93:0] grn_leds_s1_agent_rp_data;                                                 // grn_leds_s1_agent:rp_data -> router_009:sink_data
	wire         grn_leds_s1_agent_rp_ready;                                                // router_009:sink_ready -> grn_leds_s1_agent:rp_ready
	wire         grn_leds_s1_agent_rp_startofpacket;                                        // grn_leds_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         grn_leds_s1_agent_rp_endofpacket;                                          // grn_leds_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         grn_leds_s1_agent_rdata_fifo_src_valid;                                    // grn_leds_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] grn_leds_s1_agent_rdata_fifo_src_data;                                     // grn_leds_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         grn_leds_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_007:in_0_ready -> grn_leds_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> grn_leds_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> grn_leds_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // grn_leds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> grn_leds_s1_agent:rdata_fifo_sink_error
